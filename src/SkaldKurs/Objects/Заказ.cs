...
namespace IIS.SkaldKurs
{
    ...
    public class Заказ : IIS.SkaldKurs.Документ
    {
        ...
        private IIS.SkaldKurs.СостояниеЗаказа fСтатус;
        
        private IIS.SkaldKurs.Сотрудник fСотрудник;
        
        private IIS.SkaldKurs.DetailArrayOfСтрокаЗаказа fСтрокаЗаказа;
        ...
        public virtual IIS.SkaldKurs.СостояниеЗаказа Статус
        {
            get
            {
                ...
                IIS.SkaldKurs.СостояниеЗаказа result = this.fСтатус;
        ...
        public virtual IIS.SkaldKurs.DetailArrayOfСтрокаЗаказа СтрокаЗаказа
        {
            get
            {
                ...
                {
                    this.fСтрокаЗаказа = new IIS.SkaldKurs.DetailArrayOfСтрокаЗаказа(this);
                }
                IIS.SkaldKurs.DetailArrayOfСтрокаЗаказа result = this.fСтрокаЗаказа;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаказE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказE", typeof(IIS.SkaldKurs.Заказ));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаказL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказL", typeof(IIS.SkaldKurs.Заказ));
                }
            }
        }
    }
