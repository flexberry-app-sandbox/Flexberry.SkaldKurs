...
namespace IIS.SkaldKurs
{
    ...
    public class Склад : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.SkaldKurs.DetailArrayOfТоварНаСкладе fТоварНаСкладе;
        ...
        public virtual IIS.SkaldKurs.DetailArrayOfТоварНаСкладе ТоварНаСкладе
        {
            get
            {
                ...
                {
                    this.fТоварНаСкладе = new IIS.SkaldKurs.DetailArrayOfТоварНаСкладе(this);
                }
                IIS.SkaldKurs.DetailArrayOfТоварНаСкладе result = this.fТоварНаСкладе;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СкладE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СкладE", typeof(IIS.SkaldKurs.Склад));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СкладL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СкладL", typeof(IIS.SkaldKurs.Склад));
                }
            }
        }
    }
