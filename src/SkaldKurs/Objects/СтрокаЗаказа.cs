...
namespace IIS.SkaldKurs
{
    ...
    public class СтрокаЗаказа : ICSSoft.STORMNET.DataObject
    {
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.SkaldKurs.Заказ.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СтрокаЗаказаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СтрокаЗаказаE", typeof(IIS.SkaldKurs.СтрокаЗаказа));
                }
            }
        }
    }
    ...
    public class DetailArrayOfСтрокаЗаказа : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.SkaldKurs.DetailArrayOfСтрокаЗаказа members)

        // *** End programmer edit section *** (IIS.SkaldKurs.DetailArrayOfСтрокаЗаказа members)
        ...
        /// </summary>
        public DetailArrayOfСтрокаЗаказа(IIS.SkaldKurs.Заказ fЗаказ) : 
                base(typeof(СтрокаЗаказа), ((ICSSoft.STORMNET.DataObject)(fЗаказ)))
        {
        }
        
        public IIS.SkaldKurs.СтрокаЗаказа this[int index]
        {
            get
            {
                return ((IIS.SkaldKurs.СтрокаЗаказа)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.SkaldKurs.СтрокаЗаказа dataobject)
        {
