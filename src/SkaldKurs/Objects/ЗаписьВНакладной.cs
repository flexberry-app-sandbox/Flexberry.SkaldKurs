...
namespace IIS.SkaldKurs
{
    ...
    public class ЗаписьВНакладной : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.SkaldKurs.Накладная fНакладная;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.SkaldKurs.Накладная.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Накладная"})]
        public virtual IIS.SkaldKurs.Накладная Накладная
        {
            get
            {
                ...
                IIS.SkaldKurs.Накладная result = this.fНакладная;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаписьВНакладнойE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаписьВНакладнойE", typeof(IIS.SkaldKurs.ЗаписьВНакладной));
                }
            }
        }
    }
    ...
    public class DetailArrayOfЗаписьВНакладной : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.SkaldKurs.DetailArrayOfЗаписьВНакладной members)

        // *** End programmer edit section *** (IIS.SkaldKurs.DetailArrayOfЗаписьВНакладной members)
        ...
        /// </summary>
        public DetailArrayOfЗаписьВНакладной(IIS.SkaldKurs.Накладная fНакладная) : 
                base(typeof(ЗаписьВНакладной), ((ICSSoft.STORMNET.DataObject)(fНакладная)))
        {
        }
        
        public IIS.SkaldKurs.ЗаписьВНакладной this[int index]
        {
            get
            {
                return ((IIS.SkaldKurs.ЗаписьВНакладной)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.SkaldKurs.ЗаписьВНакладной dataobject)
        {
